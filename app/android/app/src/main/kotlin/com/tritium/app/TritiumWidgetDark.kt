...
class TritiumWidgetDark : AppWidgetProvider() {
    ...
    private fun setupButtonClicks(context: Context, views: RemoteViews, widgetId: Int) {
        ...
        buttons.forEach { (buttonId, value) ->
            val intent = Intent(context, TritiumWidgetDark::class.java).apply {
                action = "BUTTON_PRESS"
        ...
        // DEL button
        val delIntent = Intent(context, TritiumWidgetDark::class.java).apply {
        ...
        // AC button
        val acIntent = Intent(context, TritiumWidgetDark::class.java).apply {
            action = "BUTTON_CLEAR"
            putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, widgetId)
        }
        views.setOnClickPendingIntent(
        ...
        val ansIntent = Intent(context, TritiumWidgetDark::class.java).apply {
            action = "BUTTON_ANS"
            putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, widgetId)
        }
        views.setOnClickPendingIntent(
        ...
        val equalsIntent = Intent(context, TritiumWidgetDark::class.java).apply {
